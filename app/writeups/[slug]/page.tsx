...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return post ? { title: post.title, description: post.excerpt, openGraph: { type: "article", title: post.title, description: post.excerpt, publishedTime: post.date, modifiedTime: post.modified } } : {};
}
...
export default async function PostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="cc-section cc-article-wrap">
