...
export function Terminal() {
  ...
  function run(raw: string) {
    ...
    if (command === "whoami") return append({ command: raw, message: 'John Fiel "jf0x3f" Brosas' });
  ...
  return (
    <div className="cc-terminal" aria-label="CyberCentauri system overview">
      ...
      <div className="cc-terminal-body">
        ...
        <p className="cc-terminal-ready-2 text-center text-4xl text-terminal-cyan">John Fiel &quot;jf0x3f&quot; Brosas</p>
